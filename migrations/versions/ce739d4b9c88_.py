...
Revision ID: ce739d4b9c88
Revises: 38d65b917c68
Create Date: 2021-04-08 17:05:53.915093
...
revision = 'ce739d4b9c88'
down_revision = '38d65b917c68'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('artist_id', 'artist_name')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('venue_id', 'venue_name')
    )
    op.drop_table('Venue')
    ...
    op.create_unique_constraint(None, 'shows', ['artist_id', 'artist_name', 'artist_image_link'])
    op.create_unique_constraint(None, 'shows', ['venue_id', 'venue_name'])
